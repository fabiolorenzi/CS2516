...
PluginEditor::PluginEditor(PluginProcessor& pluginProcessor)
    : AudioProcessorEditor(&pluginProcessor),
      ...
      midHighGain("MidHigh Gain", pluginProcessor.apvts, "MIDHIGHGAIN", 0.0f, 24.0f, "dB", true),
      midLowFreq("MidLow Freq", pluginProcessor.apvts, "MIDLOWFREQ", 0.0f, 24.0f, "dB", true),
      midLowGain("MidLow Gain", pluginProcessor.apvts, "MIDLOWGAIN", 0.0f, 24.0f, "dB", true),
      lowFreq("Low Freq", pluginProcessor.apvts, "LOWFREQ", 0.0f, 24.0f, "dB", true),
      lowGain("Low Gain", pluginProcessor.apvts, "LOWGAIN", 0.0f, 24.0f, "dB", true),
